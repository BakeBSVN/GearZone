...
CATEGORY_IMAGES = {6: "switches.jpg", 7: "accessories.jpg", 8: "groceries.jpg", 9: "apparel.jpg"}
...
#         if parent is None:
#             image_name = CATEGORY_IMAGES.get(pk, None)
#         else:
#             # image_name = (
#             #     CATEGORY_IMAGES[pk] if pk in CATEGORY_IMAGES else CATEGORY_IMAGES[parent]
#             # )
#             image_name = CATEGORY_IMAGES.get(pk, CATEGORY_IMAGES.get(parent))
#         if image_name:  # Ensure image_name is not None
...
def create_shipping_zones():
    ...
    yield create_shipping_zone(
        ...
        shipping_methods_names=["GHTK", "TNT", "NinjaVan", "J&T Express"],
    )
    # american_countries = [
    #     "AI",
    #     "AG",
